...
CREATE TABLE `esemed` (
  `eseme_id` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `eseme_nimi` varchar(50) NOT NULL,
  `kogus` int(6) NOT NULL,
  PRIMARY KEY (`eseme_id`)
...
CREATE TABLE `kasutajad` (
  `kasutaja_id` int(6) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2016-05-21 21:14:21
